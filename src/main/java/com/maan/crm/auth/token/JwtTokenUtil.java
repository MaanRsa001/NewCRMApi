...
import static com.maan.crm.auth.token.Constants.ACCESS_TOKEN_VALIDITY_SECONDS;
import static com.maan.crm.auth.token.Constants.SIGNING_KEY;
...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateToken(ClaimLoginMaster user) {
