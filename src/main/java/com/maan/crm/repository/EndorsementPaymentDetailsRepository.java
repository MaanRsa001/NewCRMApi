...
public interface EndorsementPaymentDetailsRepository  extends JpaRepository<EndorsementPaymentDetails,EndorsementPaymentDetailsId> , JpaSpecificationExecutor<EndorsementPaymentDetails> {

	List<EndorsementPaymentDetails> findAllByOrderByEndorsementPaymentIdDesc();
