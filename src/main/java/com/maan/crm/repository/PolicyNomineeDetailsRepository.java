...
public interface PolicyNomineeDetailsRepository  extends JpaRepository<PolicyNomineeDetails,PolicyNomineeDetailsId> , JpaSpecificationExecutor<PolicyNomineeDetails> {

	List<PolicyNomineeDetails> findAllByOrderByNomineeIdDesc();

	List<PolicyNomineeDetails> findByPolicyId(int policyId);

	Page<PolicyNomineeDetails> findByNomineeIdAndPolicyId(Pageable paging, Integer nomineeId, Integer policyId);
