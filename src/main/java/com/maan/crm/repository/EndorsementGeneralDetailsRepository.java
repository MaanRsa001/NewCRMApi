...
public interface EndorsementGeneralDetailsRepository  extends JpaRepository<EndorsementGeneralDetails,EndorsementGeneralDetailsId> , JpaSpecificationExecutor<EndorsementGeneralDetails> {


	List<EndorsementGeneralDetails> findAllByOrderByEndorsementIdDesc();
