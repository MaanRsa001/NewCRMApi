...
public interface PolicyPaymentDetailsRepository  extends JpaRepository<PolicyPaymentDetails,PolicyPaymentDetailsId> , JpaSpecificationExecutor<PolicyPaymentDetails> {

	List<PolicyPaymentDetails> findAllByOrderByPolicyPaymentDetailIdDesc();

	List<PolicyPaymentDetails> findByPolicyId(int policyId);

	Page<PolicyPaymentDetails> findByPolicyIdAndPaymentdetailsid(Pageable paging, int policyId, int paymentdetailsid);
