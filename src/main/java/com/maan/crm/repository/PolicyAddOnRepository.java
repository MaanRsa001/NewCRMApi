...
public interface PolicyAddOnRepository  extends JpaRepository<PolicyAddOn,PolicyAddOnId> , JpaSpecificationExecutor<PolicyAddOn> {

	List<PolicyAddOn> findAllByOrderByAddOnidDesc();

	List<PolicyAddOn> findByPolicyid(int policyid);

	Page<PolicyAddOn> findByAddOnidAndPolicyid(Pageable paging, Integer addOnid, Integer policyid);
