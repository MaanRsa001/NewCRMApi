...
import com.maan.crm.bean.TrackingDetailsId;
...
public interface TrackingDetailsRepository
		extends JpaRepository<TrackingDetails, TrackingDetailsId>,
		JpaSpecificationExecutor<TrackingDetails> {

	List<TrackingDetails> OrderByEntryDateDesc();

	List<TrackingDetails> findByClientRefNo(String clientRefNo);
