...
public interface CommissionService {
	...
	// Commission Motor
	List<Error> validateCommissionMotor(CommissionMotorDetailsSaveReq req);

	CommissionSuccessRes saveCommissionMotor(CommissionMotorDetailsSaveReq req);

	CommissionMotorDetailsRes getCommissionMotor(CommissionMotorDetailsGetReq req);

	// Commission Non Motor
	
	List<Error> validateCommissionNonMotor(CommissionNonMotorDetailsSaveReq req);

	CommissionSuccessRes saveCommissionNonMotor(CommissionNonMotorDetailsSaveReq req);

	CommissionNonMotorDetailsRes getCommissionNonMotor(CommissionNonMotorDetailsGetReq req);
