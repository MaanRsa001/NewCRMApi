...
import com.maan.crm.notification.sms.dto.Sms;
import com.maan.crm.notification.sms.dto.SmsConfigMasterDto;
...
import com.maan.crm.service.impl.MailDetailsServiceImpl;
import com.maan.crm.service.impl.SmsServiceImplementation;
...
/*
	...
	*/
	...
	public SuccessRes SendSms(SmsReq req) {
		...
		ModelMapper mapper = new ModelMapper();
		Optional<SmsConfigMaster> master = smsm.findById(req.getInsuranceid());
		SmsConfigMasterDto rep=mapper.map(master.get(), SmsConfigMasterDto.class);
